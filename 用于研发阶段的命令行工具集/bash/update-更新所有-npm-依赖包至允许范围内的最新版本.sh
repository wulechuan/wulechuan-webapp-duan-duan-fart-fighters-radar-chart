...
function 完整流程 {
    ...
    Update-吴乐川更新当前_npm_项目的所有依赖包 \
        --某产品级依赖包之版本配置 "          @wulechuan/echarts-vue2-component   |:|   latest   |:|" \
        --某产品级依赖包之版本配置 "                                    echarts   |:|   latest   |:|" \
        --某产品级依赖包之版本配置 "                                        vue   |:|   ^2.6     |:|" \
        --某产品级依赖包之版本配置 "                        vue-class-component   |:|   latest   |:|" \
        --某产品级依赖包之版本配置 "                     vue-property-decorator   |:|   latest   |:|" \
        --某产品级依赖包之版本配置 "                                 vue-router   |:|   ~3       |:|" \
        --某产品级依赖包之版本配置 "                                       vuex   |:|   ^3       |:|" \
        --某研发级依赖包之版本配置 "                             @types/echarts   |:|   latest   |:|" \
        --某研发级依赖包之版本配置 "           @typescript-eslint/eslint-plugin   |:|   latest   |:|" \
        --某研发级依赖包之版本配置 "                  @typescript-eslint/parser   |:|   latest   |:|" \
        --某研发级依赖包之版本配置 "                     @vue/cli-plugin-eslint   |:|   latest   |:|" \
        --某研发级依赖包之版本配置 "                     @vue/cli-plugin-router   |:|   latest   |:|" \
        --某研发级依赖包之版本配置 "                 @vue/cli-plugin-typescript   |:|   latest   |:|" \
        --某研发级依赖包之版本配置 "                       @vue/cli-plugin-vuex   |:|   latest   |:|" \
        --某研发级依赖包之版本配置 "                           @vue/cli-service   |:|   latest   |:|" \
        ...
        --某研发级依赖包之版本配置 "                          eslint-plugin-vue   |:|   latest   |:|" \
        --某研发级依赖包之版本配置 "                                     stylus   |:|   latest   |:|" \
        --某研发级依赖包之版本配置 "                              stylus-loader   |:|   latest   |:|" \
        --某研发级依赖包之版本配置 "                                 typescript   |:|   latest   |:|" \
        --某研发级依赖包之版本配置 "                      vue-template-compiler   |:|   ^2.6     |:|" \
        --内容分割记号='|:|' \
        --NPM安装依赖包时须额外带上的参数序列="$NpmArguments" \
        --调试功能之级别 0 \
        --应仅作仿真演练 false
